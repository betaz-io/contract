...
import { ContractAbi } from '../contract-info/dao_contract';
import QueryMethods from '../query/dao_contract';
import BuildExtrinsicMethods from '../build-extrinsic/dao_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/dao_contract';
import MixedMethods from '../mixed-methods/dao_contract';
import EventsClass from '../events/dao_contract';
