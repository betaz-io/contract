...
import { ContractAbi } from '../contract-info/betaz_random';
import QueryMethods from '../query/betaz_random';
import BuildExtrinsicMethods from '../build-extrinsic/betaz_random';
import TxSignAndSendMethods from '../tx-sign-and-send/betaz_random';
import MixedMethods from '../mixed-methods/betaz_random';
import EventsClass from '../events/betaz_random';
