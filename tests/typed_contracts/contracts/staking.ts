...
import { ContractAbi } from '../contract-info/staking';
import QueryMethods from '../query/staking';
import BuildExtrinsicMethods from '../build-extrinsic/staking';
import TxSignAndSendMethods from '../tx-sign-and-send/staking';
import MixedMethods from '../mixed-methods/staking';
import EventsClass from '../events/staking';
