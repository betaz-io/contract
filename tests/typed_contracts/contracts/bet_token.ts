...
import { ContractAbi } from '../contract-info/bet_token';
import QueryMethods from '../query/bet_token';
import BuildExtrinsicMethods from '../build-extrinsic/bet_token';
import TxSignAndSendMethods from '../tx-sign-and-send/bet_token';
import MixedMethods from '../mixed-methods/bet_token';
import EventsClass from '../events/bet_token';
