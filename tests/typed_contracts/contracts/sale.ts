...
import { ContractAbi } from '../contract-info/sale';
import QueryMethods from '../query/sale';
import BuildExtrinsicMethods from '../build-extrinsic/sale';
import TxSignAndSendMethods from '../tx-sign-and-send/sale';
import MixedMethods from '../mixed-methods/sale';
import EventsClass from '../events/sale';
