...
import { ContractAbi } from '../contract-info/beta0_core';
import QueryMethods from '../query/beta0_core';
import BuildExtrinsicMethods from '../build-extrinsic/beta0_core';
import TxSignAndSendMethods from '../tx-sign-and-send/beta0_core';
import MixedMethods from '../mixed-methods/beta0_core';
import EventsClass from '../events/beta0_core';
