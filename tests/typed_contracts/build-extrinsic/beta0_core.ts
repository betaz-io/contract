...
export default class Methods {
	...
	*/
	"withdrawToken" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "betA0CoreTrait::withdrawToken", [value], __options);
	}
	...
	*/
	"getTokenBalancePool" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "betA0CoreTrait::getTokenBalancePool", [pool], __options);
	}
