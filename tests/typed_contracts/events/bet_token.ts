import type * as EventTypes from '../event-types/bet_token';
...
export default class EventsClass {
	...
	public subscribeOnBurnEvent(callback : (event : EventTypes.Burn) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('Burn', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.Burn);
		};
